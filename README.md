...
- [3. Read and process the data](#3-read-and-process-the-data)
	...
	- [3.2 Denoising](#32-denoising)
- [4. Phylogenetic diversity analyses](#4-phylogenetic-diversity-analyses)
	- [4.1 Categorical tests](#41-categorical-tests)
	- [4.2 Continuous tests](#42-continuous-tests)
	- [4.3 Alpha rarefaction](#43-alpha-rarefaction)
